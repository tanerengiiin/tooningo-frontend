...
const buttonVariants = cva(
  ...
  focus:outline-1 focus:outline-[rgba(255,87,188,0.5)] focus:outline-offset-[3px] 
  `,
  {
    variants: {
      variant: {
        ...
        purple:
          ...
          pink: "bg-gradient-to-b from-white/[0.12] to-white/0 bg-[var(--form-button-constructive-normal)] shadow-[0_0px_0px_1px_#E769B4,0_1px_2px_0px_rgba(203,74,151,0.5)] after:bg-gradient-to-b after:from-white/[0.12] after:to-white/0 after:bg-[var(--form-button-constructive-normal)] active:after:bg-gradient-to-b active:after:from-white/0 active:after:to-white/[0.16] active:after:bg-[var(--form-button-constructive-pressed)] active:bg-gradient-to-b active:from-white/0 active:to-white/[0.16] active:bg-[var(--form-button-constructive-pressed)] active:[&>span]:before:bg-gradient-to-b active:[&>span]:before:from-white/0 active:[&>span]:before:to-white/[0.16] active:[&>span]:before:bg-[var(--form-button-constructive-pressed)] active:[&>span]:before:opacity-[0.14]",
      },
      size: {
        default: "",
      },
  ...
  ({ className, variant, size, asChild = false, children, ...props }, ref) => {
    ...
    return (
      ...
      >
        <span
          className={`
                    flex justify-center items-center flex-1 z-[5] py-[6px] px-[8px] text-sm leading-8 font-medium text-white text-center rounded-lg transition-all duration-150
                    before:content-[""] before:absolute before:top-0 before:left-0 before:right-0 before:bottom-0 before:bg-gradient-to-b before:from-white before:to-white/0 before:opacity-[0.07] before:rounded-lg before:transition-all before:duration-150 group-hover:before:opacity-[0.14] 
